...
import com.chinacache.stormkafka.trident.GlobalPartitionInformation;
import com.chinacache.stormkafka.trident.IBrokerReader;
import com.chinacache.stormkafka.trident.StaticBrokerReader;
import com.chinacache.stormkafka.trident.ZkBrokerReader;
...
public class KafkaUtils {
    ...
    public static ByteBufferMessageSet fetchMessages(KafkaConfig config, SimpleConsumer consumer, Partition partition, long offset) throws UpdateOffsetException {
        ...
        try {
        	...
        	{
        		ipMap.put("223.203.199.148", "172.16.10.84");
        		ipMap.put("223.203.199.149", "172.16.10.85");
        		ipMap.put("223.203.199.150", "172.16.10.86");
        		ipMap.put("223.203.199.151", "172.16.10.96");
        		ipMap.put("223.203.199.152", "172.16.10.97");
        		ipMap.put("223.203.199.153", "172.16.10.98");
        		ipMap.put("223.203.199.154", "172.16.10.99");        		
        	}
        	String host_inner = ipMap.get(consumer.host());
        	SimpleConsumer sc_inner = new SimpleConsumer(host_inner,consumer.port(),consumer.soTimeout(),consumer.bufferSize(),consumer.clientId());
        	System.out.println("sc_inner host: " + sc_inner.host());
        	fetchResponse = sc_inner.fetch(fetchRequest);
        	*/
